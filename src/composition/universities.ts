...
import { PrismaUniversityBreakRepository } from "../infrastructure/persistence/prisma/prisma-university-break-repository";
...
export function createUniversityService(): UniversityService {
  ...
  return new UniversityService(
    ...
    new PrismaUniversityBreakRepository(prisma),
  );
}
